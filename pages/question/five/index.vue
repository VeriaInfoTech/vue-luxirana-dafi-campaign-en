...
export default {
  ...
  data() {
    return {
      assets: 'assets/images/question-5/',
      title: 'Campaign',
  ...
  methods: {
    ...
    goNext(value) {
      this.$store.dispatch("answer/answer_5", value);
      this.$router.push('/question/six');
    },
  },
  layout: "question",
}
...
<template>
  <div>
    ...
    <center>
      <img
        src="~/assets/images/question-5/question.png"
        :width="ratio * 610"
        :height="ratio * 104"
      >
    </center>
    ...
    <center>
      <img
        src="~/assets/images/question-5/answer-1.png"
        :width="ratio * 272"
        :height="ratio * 121"
        @click="goNext(0)"
      >
    ...
    <center>
      <img
        src="~/assets/images/question-5/answer-2.png"
        :width="ratio * 272"
        :height="ratio * 121"
        @click="goNext(1)"
      >
