...
export default {
  ...
  data() {
    return {
      assets: 'assets/images/question-4/',
      title: 'Question 4',
  ...
  methods: {
    ...
    goNext(value) {
      this.$store.dispatch("answer/answer_4", value);
      this.$router.push('/question/five');
    },
  },
  layout: "question",
}
...
<template>
  <div>
    ...
    <center>
      <img
        src="~/assets/images/question-4/question.png"
        :width="ratio * 714"
        :height="ratio * 104"
      >
    </center>
    ...
    <center>
      <img
        src="~/assets/images/question-4/answer-1.png"
        :width="ratio * 379"
        :height="ratio * 122"
        @click="goNext(0)"
      >
    ...
    <center>
      <img
        src="~/assets/images/question-4/answer-2.png"
        :width="ratio * 583"
        :height="ratio * 122"
        @click="goNext(1)"
      >
